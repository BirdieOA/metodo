				...
				<section>
					<div className='flex justify-center items-center '>
						<ul className='flex flex-col justify-center items-center'>
							...
							<li className='text-slate-700 hover:scale-110 ease-in duration-200 font-bold text-xl'>
								<Link to='/'>Inicio</Link>
							</li>
							<li className='text-slate-700 hover:scale-110 ease-in duration-200 font-bold text-xl'>
					...
					<div className='flex flex-col justify-center items-center'>
						...
						<div className='grid lg:flex gap-10'>
							<a href='https://www.instagram.com/elmetodoadulma/' className=''>
								<BsInstagram
									className='fill-slate-700 cursor-pointer hover:fill-white ease-in duration-200'
									size={60}
								/>
							</a>
				...
				<section>
					<div className='flex justify-center items-center '>
						<ul className='flex flex-col items-center '>
							...
							<li className='text-slate-700 hover:scale-110 ease-in duration-200 font-bold font-poppinsRegular text-xl'>
