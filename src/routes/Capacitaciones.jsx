		...
		<>
			<section id='capacitaciones'>
							...
							<div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-80 z-10'>
								<div className='flex flex-col justify-center w-full h-screen sm:w-full lg:w-[1100px] mt-20 bg-[#FEE6B9] text-slate-700 p-4'>
									...
									<p className='text-xl font-black text-slate-700 bg-white rounded-lg shadow-lg p-8 max-h-[400px] sm:max-h-[120px] lg:max-h-[600px] overflow-y-auto lg:max-w-[1100px] lg:text-center'>
										...
										de intervención en el abordaje de la tercera edad, detectar
										características patológicas en el envejecimiento y diseñar
										...
										Acompañantes Terapéuticos, Cuidadores, Enfermeros,
										Licenciados de la salud, Profesores de Educación Física,
										Kinesiólogos, Fisioterapeutas, médicos Gerontólogos y
										Neurólogos. La capacitación incluye cómo armar tu propio
										grupo de personas mayores con publicidad gratuita.
									</p>
				...
				<div className='flex flex-col bg-[#FEE6B9] lg:h-screen justify-between items-center'>
					...
					<section className='flex flex-col col-span-3 gap-10 p-4'>
						{/* <CursoDos/> */}
						<h1 className='lg:text-4xl flex items-center text-slate-700 bg-[#FDB259] p-4 border-4 border-orange-400 shadow-lg shadow-orange-700/40 rounded-lg font-poppinsRegular font-semibold'>
							- Prevención actualizada y continua en la Salud del Adulto Mayor.
						</h1>
						<h1 className='lg:text-4xl flex items-center font-bold text-slate-700 bg-[#FDB259] p-4 border-4 border-orange-400 shadow-lg shadow-orange-700/40 rounded-lg font-poppinsRegular '>
							- Prevenir el maltrato al Adulto Mayor y enfrentarlo.
						</h1>
						<h1 className='lg:text-4xl flex items-center font-semibold text-slate-700 bg-[#FDB259] p-4 border-4 border-orange-400 shadow-lg shadow-orange-700/40 rounded-lg font-poppinsRegular'>
			...
			<section className='flex flex-col gap-10 p-5 sm:p-20 mb-10 lg:mx-60'>
				<figure className='grid lg:grid-cols-2 gap-10'>
					<video
						className='shadow-lg lg:col-span-1 shadow-orange-700 rounded-lg z-0 lg:w-full '
						src='/1cap.mp4'
					...
					/>
					<video
						className='shadow-lg lg:col-span-1 shadow-orange-700 col-span-1 rounded-lg lg:w-full '
						src='/2cap.mp4'
						alt='fotografias de capacitaciones'
						controls
						autoPlay={false}
				...
				<img
					...
					alt='fotografias de capacitaciones'
				/> */}
				<figure className='grid lg:grid-cols-3 gap-10'>
					<img
						className='shadow-lg shadow-orange-700 col-span-1 rounded-lg  lg:h-full'
						src='/4cap.png'
						alt='fotografias de capacitaciones'
					/>
					<img
